...
public class DataSet {
	String filePath;
	roadgraph.mainDatastructure graph;
    ...
    public void setGraph(roadgraph.mainDatastructure graph) {
    	this.graph = graph;
    }

    public void setRoads(HashMap<geography.GeographicPoint,HashSet<geography.RoadSegment>>  roads) { this.roads = roads; }
    public roadgraph.mainDatastructure getGraph(){ return graph; }
    ...
    public void initializeGraph() {
        graph = new roadgraph.mainDatastructure();
