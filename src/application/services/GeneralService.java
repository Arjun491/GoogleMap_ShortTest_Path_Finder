...
//	private static boolean singleton = false;
    ...
    public void runFetchTask(String fName, ComboBox<DataSet> cb, Button button) {
        ...
        Alert fetchingAlert = ShortestPathFinder.getInfoAlert("Loading : ", "Fetching data for current map area...");
        task.setOnSucceeded( e -> {
          if(task.getValue().equals(fName)) {
               ...
               ShortestPathFinder.showInfoAlert("Fetch completed : ", "Data set : \"" + fName + "\" written to file!");
